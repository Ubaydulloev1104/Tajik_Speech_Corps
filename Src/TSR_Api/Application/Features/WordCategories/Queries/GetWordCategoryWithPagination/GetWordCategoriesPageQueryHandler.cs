...
{
    public class GetWordCategoriesPageQueryHandler : IRequestHandler<PagedListQuery<CategoryResponse>,
        PagedList<CategoryResponse>>
    {
        ...
        public GetWordCategoriesPageQueryHandler(IApplicationDbContext dbContext,
